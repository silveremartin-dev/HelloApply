 ...
 * VERSION: 4.0.0 (Markdown-to-Doc Generation Engine)
 * LAST UPDATED: 18/05/2026 18:30
 * 
 * New:
...
function generateFilesFromTemplate(inputFolder, outputFolder, templateName, markdownText, finalName) {
  ...
  // Render Markdown beautifully with styles!
...
function renderMarkdownToDoc(body, markdownText) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (line.startsWith('# ')) {
      // Main Heading (centered, name/title)
      ...
      // Section Heading (e.g. ## COMPÉTENCES CLÉS)
